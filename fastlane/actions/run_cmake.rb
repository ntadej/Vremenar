    ...
    class RunCmakeAction < Action
      def self.run(params)
        ...
        when 'macos'
          ...
          command += " -DCMAKE_OSX_DEPLOYMENT_TARGET='13.0' -DCMAKE_OSX_ARCHITECTURES='x86_64;arm64'"
        ...
        when 'ios'
          command += ' -G Xcode'
          command += " -DCMAKE_OSX_DEPLOYMENT_TARGET='17.0' -DCMAKE_OSX_ARCHITECTURES='arm64'"
