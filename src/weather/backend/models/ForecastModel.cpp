...
Backend::ForecastModel::ForecastModel(QObject *parent)
    : ForecastModelBase(parent) {}

ForecastEntry *Backend::ForecastModel::createEntry(const QJsonObject &data)
{
    ...
    zoomLevel *= Backend::maxZoomLevel - Backend::minZoomLevel - epsilon;
    zoomLevel = Backend::maxZoomLevel - zoomLevel - epsilon;
...
void Backend::ForecastModel::addEntries(const QJsonArray &data)
{
